...
## Appendix: Core Molecular Descriptors for Toxicity Prediction
When the AI scans a solvent's molecular anatomy, it prioritizes the following physical and thermodynamic laws to predict biological compatibility:

| Rank  | Descriptor                                    | Importance | Why it is Important                                                                                                                                                                                                                                                                                                                       |
| ----- | --------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **XLogP (LogP)**                              | ⭐⭐⭐⭐⭐      | The single most important descriptor. LogP determines the solvent's affinity for lipid membranes. Solvents with high LogP partition into the cell membrane, disrupting membrane integrity, reducing glucose transport, and impairing intracellular enzyme activity. It is one of the strongest predictors of microbial solvent tolerance. |
| **2** | **Dielectric Constant**                       | ⭐⭐⭐⭐⭐      | Represents solvent polarity. Polarity influences protein stability, enzyme hydration, and membrane interactions. Highly polar and highly non-polar solvents can both reduce catalytic activity through different mechanisms.                                                                                                              |
| **3** | **Water Solubility**                          | ⭐⭐⭐⭐☆      | Determines how much solvent partitions into the aqueous phase versus the membrane. Water-soluble solvents remain primarily in the fermentation broth, whereas poorly soluble solvents preferentially accumulate in lipid membranes, affecting glucose uptake and substrate conversion.                                                    |
| **4** | **Dynamic Viscosity**                         | ⭐⭐⭐⭐☆      | Influences mass transfer, substrate diffusion, oxygen transfer, and mixing. High-viscosity solvents can reduce diffusion rates and slow substrate transport to cells, indirectly lowering glucose uptake and reaction rates.                                                                                                              |
| **5** | **Hansen Solubility Parameters (δD, δP, δH)** | ⭐⭐⭐⭐☆      | These parameters describe dispersion, polar, and hydrogen-bonding interactions between solvents and biological membranes. They often explain solvent compatibility better than LogP alone because they capture multiple interaction mechanisms.                                                                                           |
| **6** | **Surface Tension**                           | ⭐⭐⭐☆☆      | Affects wetting of the cell surface, droplet formation in biphasic systems, gas–liquid transfer, and solvent dispersion. These factors influence solvent availability and mass transfer during biocatalysis.                                                                                                                              |
| **7** | **Molecular Weight**                          | ⭐⭐⭐☆☆      | Serves as a proxy for molecular size and diffusivity. Smaller molecules generally diffuse through membranes more readily than larger molecules, although molecular weight alone is usually less predictive than LogP or polarity.                                                                                                         |
